...
replace github.com/sagernet/sing-box => github.com/akari-project/sing-box v1.14.0-alpha.2.0.20260923131552-de00961c8e81

replace github.com/xtls/xray-core => github.com/akari-project/xray-core v0.0.0-20260923131559-97985114ef07
